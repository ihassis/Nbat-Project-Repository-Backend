...
public class SecurityUtils {
    ...
    private static List<SimpleGrantedAuthority> mapRolesToGrantedAuthorities(Collection<String> roles) {
        ...
        return List.of(new SimpleGrantedAuthority("ROLE_TENANT")); // Rôle par défaut
    }
    ...
    private static Stream<String> getAuthorities(Authentication authentication) {
        Collection<? extends GrantedAuthority> authorities = authentication
                instanceof JwtAuthenticationToken jwtAuthenticationToken && jwtAuthenticationToken.getToken() != null ?
